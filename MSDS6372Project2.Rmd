...
Default RF ntree = 10 and m variables =sqrt(p) seem to work better than ntree=100
```{r}
...
confusionMatrix(class.rf,adult.test$income)
...
legend("bottomright",legend=c("Simple LR","Complex LG","LDA","Random Forest"),col=c("black","orange","blue","green"),lty=1,lwd=1)
abline(a=0, b= 1)
