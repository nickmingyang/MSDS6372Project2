...
table(income,sex) # sex can be contributing to income
table(income,workclass)
table(income,education) # Master, Prof-school, Doctorate all have more people making over 50k
...
#ggpairs(reduced,aes(colour=income)) # commented out due to slow run time - under images continous_pair.png
```
